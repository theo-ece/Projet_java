...
public class Chargement {
    ...
    public void initialisation(){
        ...
        chargementDetailsBulletins();
        chargementBulletins();
        chargementDisciplines();
        chargementAnneeScolaires();
        chargementClasses();
        chargementEtudiants();
        chargementEnseignants();
        chargementNiveaux();
        chargementEnseignement();
        chargementInscription();
        chargementEcoles();
    }
    ...
    /** chargementEnseignants : methode permettant de charger les elements Enseignant et Etudiant */
    public void chargementEnseignants(){
    ...
    public HashMap<Integer,Etudiant> chargementEtudiants(){
        ...
        try {
            ...
            for(int i=0; i<liste_Id.size(); i++){
                ...
                //Si c'est un Etudiant, alors création d'un Etudiant
                if(personne.getType() == 0){
